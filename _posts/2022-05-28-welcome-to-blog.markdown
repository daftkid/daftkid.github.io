...
"scary" button which can explode the whole planet as I thought then 😂.
...
the things like "where is 'My Computer' icon, where is a 'Start' button" and so on 😂.
...
I can say that it was really tough to meet this deadline 😀.
...
guys just gave up and dropped from the course (including my friends 🥹).
...
Currently, I'm working for [SoftServe][ss] as a Lead DevOps engineer and as a Cloud Architect. Both doing by hand and talking in meetings 😀.
